...
{
    public class JsAdminImageFinderModel : PageModel
    {

        public JsAdminImageFinderModel()
        {
        ...
        public string JsonFiles { get; private set; } = "[]";
        ...
        public void OnGet()
        {
            ...
            //JsonFiles = JsonConvert.SerializeObject(files);
        }
    }
}