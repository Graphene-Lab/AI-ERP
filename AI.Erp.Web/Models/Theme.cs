...
namespace AI.Erp.Web.Models
{
	public class Theme
	{
		...
		public string BrandLogo { get; set; } = "/_content/AI.Erp.Web/assets/logo.png";

		[JsonProperty("brand_logo_text")]
		public string BrandLogoText { get; set; } = "/_content/AI.Erp.Web/assets/logo-text.png";

		[JsonProperty("brand_favicon")]
		public string BrandFavIcon { get; set; } = "/_content/AI.Erp.Web/assets/favicon.png";
		...
		public string BodyFontUrl { get; set; } = "/_content/AI.Erp.Web/css/Roboto/Roboto-Regular.ttf";
