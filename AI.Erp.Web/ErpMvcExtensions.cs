...
using AI.Erp.Web.Models.AutoMapper;
		...
		private static void CheckCreateHomePage()
		{
			...
			using (var connection = DbContext.Current.CreateConnection())
			{
				try
				{
					...
					{
						pageSrv.CreatePage(pageId, name, label, labelTranslations, iconClass, system, weight, type, appId, entityId, nodeId, areaId, isRazorBody, razorBody, layout, AI.Erp.Database.DbContext.Current.Transaction);
						pageSrv.CreatePageBodyNode(new Guid("3a4e8154-9f48-4ba5-9e11-36fa5e7a80c9"), null, pageId, null, 1, "AI.Erp.Web.Components.PcApplications", "", @"""{}""", AI.Erp.Database.DbContext.Current.Transaction);
					}
