...
using AI.Erp.Web.Service;
using AI.Erp.Web.Services;
using AI.Erp.Web.Utils;
using Wangkanai.Detection.Services;

namespace AI.Erp.Web.Controllers
{
	[Authorize]
	public class WebApiController : ApiControllerBase
	{
		...
		public ActionResult ToggleSection(Guid? nodeId = null, bool isCollapsed = false)
		{
			...
			try
			{
				...
				EntityRecord componentData = userPreferencesService.GetComponentData(currentUser.Id, "AI.Erp.Web.Components.PcSection");
				...
				else
				{
					if (componentData.Properties.ContainsKey("collapsed_node_ids") && componentData["collapsed_node_ids"] != null)
					{
						if (componentData["collapsed_node_ids"] is string)
						{
							...
							{
								throw new Exception("AI.Erp.Web.Components.PcSection component data object in user preferences not in the correct format. collapsed_node_ids should be List<Guid>");
							}
						}
					...
					if (componentData.Properties.ContainsKey("uncollapsed_node_ids") && componentData["uncollapsed_node_ids"] != null)
					{
						if (componentData["uncollapsed_node_ids"] is string)
						{
							...
							{
								throw new Exception("AI.Erp.Web.Components.PcSection component data object in user preferences not in the correct format. uncollapsed_node_ids should be List<Guid>");
							}
						}
				...
				userPreferencesService.SetComponentData(currentUser.Id, "AI.Erp.Web.Components.PcSection", componentData);
				response.Success = true;
				response.Message = "success";
				return Json(response);
			}
