...
{
	[PageComponent(Label = "Field HTML", Library = "AI", Description = "Provides the ability of entering and presenting an HTML code. Supports multiple input languages.", Version = "0.0.1", IconClass = "fas fa-code")]
