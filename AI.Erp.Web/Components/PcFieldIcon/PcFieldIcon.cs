...
{
	[PageComponent(Label = "Field Icon", Library = "AI", Description = "An icon selector field", Version = "0.0.1", IconClass = "fab fa-font-awesome-alt")]
	public class PcFieldIcon : PcFieldBase
	{
		protected ErpRequestContext ErpRequestContext { get; set; }

		public PcFieldIcon([FromServices]ErpRequestContext coreReqCtx)
		{
			ErpRequestContext = coreReqCtx;
		}

		public class PcFieldIconOptions : PcFieldBaseOptions
		{

			public static PcFieldIconOptions CopyFromBaseOptions(PcFieldBaseOptions input)
			{
				return new PcFieldIconOptions
				{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var options = PcFieldIconOptions.CopyFromBaseOptions(baseOptions);

				if (context.Options != null)
				{
					options = JsonConvert.DeserializeObject<PcFieldIconOptions>(context.Options.ToString());
				}
				var modelFieldLabel = "";
