...
{
	[PageComponent(Label = "Field Number", Library = "AI", Description = "Only numbers are allowed. Leading zeros will be stripped.", Version = "0.0.1", IconClass = "fas fa-dice-six")]
