...
{
	[PageComponent(Label = "Field Select", Library = "AI", Description = "One value can be selected from a provided dropdown list", Version = "0.0.1", IconClass = "fas fa-caret-square-down")]
