...
{
	[PageComponent(Label = "Field Checkbox list", Library = "AI", Description = "Multiple values can be selected from a provided list", Version = "0.0.1", IconClass = "fas fa-check-double")]
