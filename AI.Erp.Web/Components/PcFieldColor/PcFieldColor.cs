...
{
	[PageComponent(Label = "Field Color", Library = "AI", Description = "A color selector field", Version = "0.0.1", IconClass = "fas fa-palette")]
	public class PcFieldColor : PcFieldBase
	{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var options = PcFieldColorOptions.CopyFromBaseOptions(baseOptions);

				if (context.Options != null)
				{
					options = JsonConvert.DeserializeObject<PcFieldColorOptions>(context.Options.ToString());
				}
				var modelFieldLabel = "";
