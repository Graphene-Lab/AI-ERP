...
{
	[PageComponent(Label = "Field Email", Library = "AI", Description = "An email can be entered by the user, which will be validated and presented accordingly", Version = "0.0.1", IconClass = "far fa-envelope")]
