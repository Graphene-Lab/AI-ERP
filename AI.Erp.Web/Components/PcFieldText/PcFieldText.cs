...
{
	[PageComponent(Label = "Field Text", Library = "AI", Description = "A simple text field. One of the most needed field nevertheless", Version = "0.0.1", IconClass = "fas fa-font")]
