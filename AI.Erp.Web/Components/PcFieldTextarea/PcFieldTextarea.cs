...
{
	[PageComponent(Label = "Field Textarea", Library = "AI", Description = "A textarea for plain text input. Will be cleaned and stripped from any web unsafe content", Version = "0.0.1", IconClass = "fas fa-paragraph")]
