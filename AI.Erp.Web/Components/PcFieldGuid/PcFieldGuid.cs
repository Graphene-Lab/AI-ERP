...
{
	[PageComponent(Label = "Field Guid", Library = "AI", Description = "Very important field for any entity to entity relation and required by it", Version = "0.0.1", IconClass = "fas fa-fingerprint")]
