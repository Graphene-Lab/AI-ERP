...
{
	[PageComponent(Label = "Field File", Library = "AI", Description = "File upload field. Files will be stored within the system.", Version = "0.0.1", IconClass = "far fa-file")]
	public class PcFieldFile : PcFieldBase
	{
		protected ErpRequestContext ErpRequestContext { get; set; }

		public PcFieldFile([FromServices]ErpRequestContext coreReqCtx)
		{
			ErpRequestContext = coreReqCtx;
		}

		public class PcFieldFileOptions : PcFieldBaseOptions
		{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var options = PcFieldFileOptions.CopyFromBaseOptions(baseOptions);
				if (context.Options != null)
				{
					options = JsonConvert.DeserializeObject<PcFieldFileOptions>(context.Options.ToString());
