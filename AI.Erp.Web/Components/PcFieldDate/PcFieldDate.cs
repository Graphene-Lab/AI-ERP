...
{
	[PageComponent(Label = "Field Date", Library = "AI", Description = "A data pickup field, that can be later converting according to a provided pattern", Version = "0.0.1", IconClass = "far fa-calendar-alt")]
