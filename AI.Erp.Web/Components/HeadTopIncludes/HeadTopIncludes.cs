			...
			#region === <link> ===
			{
				...
				#region << favicon >>
				{
					if (!includedLinkTags.Any(x => x.Href.Contains("favicon")))
					{
						...
						{
							Href = $"/_content/AI.Erp.Web/assets/favicon.png",
							Rel = RelType.Icon,
							Type = "image/png"
						});
					}
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/lib/twitter-bootstrap/css/bootstrap.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/lib/flatpickr/flatpickr.min.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/lib/select2/css/select2.min.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/css/font-awesome-5.10.2/css/all.min.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/lib/toastr.js/toastr.min.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
				...
				//		linkTagsToInclude.Add(new LinkTagInclude()
				//		{
				//			Href = "/_content/AI.Erp.Web/lib/spectrum/spectrum.min.css?cb=" + cacheKey
				//		});
				//	}
				//}
				//#endregion
