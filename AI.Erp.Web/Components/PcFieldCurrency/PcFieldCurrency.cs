...
{
	[PageComponent(Label = "Field Currency", Library = "AI", Description = "A currency amount can be entered and will be represented in a suitable formatted way", Version = "0.0.1", IconClass = "fas fa-dollar-sign")]
