...
{
	[PageComponent(Label = "Field Checkbox", Library = "AI", Description = "The simple on and off switch. This field allows you to get a True (checked) or False (unchecked) value.", Version = "0.0.1", IconClass = "far fa-check-square")]
