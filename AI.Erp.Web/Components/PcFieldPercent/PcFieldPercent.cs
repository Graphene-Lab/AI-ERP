...
{
	[PageComponent(Label = "Field Percent", Library = "AI", Description = "This will automatically present any number you enter as a percent value", Version = "0.0.1", IconClass = "fas fa-percentage")]
