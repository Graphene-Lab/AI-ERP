"use strict";
	...
	//		if (event && event.payload && event.payload.component_name === "AI.Erp.Web.Components.PcGrid"){
	//			console.log("AI.Erp.Web.Components.PcRecordList Design loaded");
	//		}
	//	});

	//	document.addEventListener("WvPbManager_Design_Unloaded", function (event) {
	//		if (event && event.payload && event.payload.component_name === "AI.Erp.Web.Components.PcGrid"){
	//			console.log("AI.Erp.Web.Components.PcRecordList Design unloaded");
	//		}
	//	});
		...
		document.addEventListener("WvPbManager_Options_Unloaded", function (event) {
			if (event && event.payload && event.payload.component_name === "AI.Erp.Web.Components.PcGrid"){
			console.log("AI.Erp.Web.Components.PcGrid UnLoad");
				var visibleColumnsCount = document.querySelector('#modal-component-options .modal-body input[name="visible_columns"]');
