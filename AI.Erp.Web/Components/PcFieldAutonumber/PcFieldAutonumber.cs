...
{
	[PageComponent(Label = "Field Autonumber", Library = "AI", Description = "If you need a automatically incremented number with each new record, this is the field you need. You can customize the display format also.", Version = "0.0.1", IconClass = "fas fa-sort-numeric-down")]
