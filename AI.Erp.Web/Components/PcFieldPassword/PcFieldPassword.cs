...
{
	[PageComponent(Label = "Field Password", Library = "AI", Description = "This field is suitable for submitting passwords or other data that needs to stay encrypted in the database", Version = "0.0.1", IconClass = "fas fa-key")]
