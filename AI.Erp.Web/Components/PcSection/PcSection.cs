...
{
	[PageComponent(Label = "Section", Library = "AI", Description = "A foldable section", Version = "0.0.1", IconClass = "far fa-object-group")]
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
                ...
                if (HttpContext.User != null) {
                    ...
                    if (currentUser != null) {
                        var componentData = new UserPreferencies().GetComponentData(currentUser.Id, "AI.Erp.Web.Components.PcSection");
