...
{
	[PageComponent(Label = "Validation", Library = "AI", Description = "Shows Validation when needed outside of a form", Version = "0.0.1", IconClass = "fas fa-exclamation-triangle")]
