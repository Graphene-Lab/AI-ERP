...
{
	[PageComponent(Label = "Field Image", Library = "AI", Description = "Image upload field. Images will be stored within the system", Version = "0.0.1", IconClass = "far fa-image")]
