	...
	public class NavViewComponent : ViewComponent
    {
		...
		public async Task<IViewComponentResult> InvokeAsync( BaseErpPageModel pageModel)
        {
			...
			#region << Generate js script >>
				...
				var scriptTemplate = FileService.GetEmbeddedTextResource(fileName, "AI.Erp.Web.Components.Nav");
			...
			ViewBag.DefaultAppName = String.IsNullOrWhiteSpace(ErpSettings.AppName) ? "AI" : ErpSettings.AppName;
