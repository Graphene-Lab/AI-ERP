...
{
	[PageComponent(Label = "Field Date & Time", Library = "AI", Description = "A date and time can be picked up and later presented according to a provided pattern", Version = "0.0.1", IconClass = "far fa-clock")]
