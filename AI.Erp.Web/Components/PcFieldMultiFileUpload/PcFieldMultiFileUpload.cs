...
{
	[PageComponent(Label = "Multi File Upload Field", Library = "AI", Description = "Specialized field for multiple file upload to directly in the FS", Version = "0.0.1", IconClass = "far fa-file")]
