...
using AI.Erp.Web.Repositories;
using static AI.Erp.Web.Components.PcFieldHtml;
using static AI.Erp.Web.Components.PcHtmlBlock;
...
namespace AI.Erp.Web.Services
{
	public class PageService : BaseService
	{
		...
		const string CACHE_KEY = "AI.Erp.Web.Services.PageService-ALL-PAGES";
