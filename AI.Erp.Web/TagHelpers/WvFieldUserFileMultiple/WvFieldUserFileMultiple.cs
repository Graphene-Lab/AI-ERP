		...
		public override Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
		{
			...
			if (Mode == WvFieldRenderMode.Form)
			{
				if (Access == WvFieldAccess.Full || Access == WvFieldAccess.FullAndCreate)
				{
					...
					{
						var scriptContent = FileService.GetEmbeddedTextResource("form.js", "AI.Erp.Web.TagHelpers.WvFieldUserFileMultiple");
			...
			else if (Mode == WvFieldRenderMode.InlineEdit)
			{
				...
				//	if (!tagHelperInitialized)
				//	{
				//		var scriptContent = FileService.GetEmbeddedTextResource("inline-edit.js", "AI.Erp.Web.TagHelpers.WvFieldFile");
				//		var scriptEl = new TagBuilder("script");
				//		scriptEl.Attributes.Add("type", "text/javascript");
