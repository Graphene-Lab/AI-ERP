...
function DataSourceFormEditInit(fieldId, propertyNameLibrary) {
	...
	DataSourceFormSimpleCode += "using AI.Erp.Web.Models;\n";
	DataSourceFormSimpleCode += "using AI.Erp.Api.Models;\n";
	...
	DataSourceFormGetDatasourceCode += "using AI.Erp.Web.Models;\n";
	DataSourceFormGetDatasourceCode += "using AI.Erp.Api.Models;\n";
	...
	DataSourceFormGetDatasourceEntityRecordToSelectOptionsCode += "using AI.Erp.Web.Models;\n";
	DataSourceFormGetDatasourceEntityRecordToSelectOptionsCode += "using AI.Erp.Api.Models;\n";
