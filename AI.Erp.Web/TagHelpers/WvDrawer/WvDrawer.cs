	...
	public class WvDrawer : TagHelper
	{
		...
		public override Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
		{
			...
			if (!String.IsNullOrWhiteSpace(Title))
			{
				...
				if (String.IsNullOrWhiteSpace(Id))
				{
					btnCloseEl.Attributes.Add("onclick", "ErpEvent.DISPATCH('AI.Erp.Web.Components.WvDrawer','close')");
				}
				else {
					btnCloseEl.Attributes.Add("onclick", "ErpEvent.DISPATCH('AI.Erp.Web.Components.WvDrawer',{htmlId:'" + Id + "',action:'close',payload:null})");
				}
			...
			{
				var scriptContent = FileService.GetEmbeddedTextResource(scriptFileName, "AI.Erp.Web.TagHelpers.WvDrawer");
