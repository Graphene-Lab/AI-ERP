//ErpEvent.DISPATCH('AI.Erp.Web.Components.PcDrawer',{htmlId:null,action:'open',payload:null})
//ErpEvent.DISPATCH('AI.Erp.Web.Components.PcDrawer',{htmlId:null,action:'close',payload:null})
...
function WebVellaErpWebComponentsPcDrawer_Init(elementId){
	...
	ErpEvent.ON('AI.Erp.Web.Components.PcDrawer',function(event){
