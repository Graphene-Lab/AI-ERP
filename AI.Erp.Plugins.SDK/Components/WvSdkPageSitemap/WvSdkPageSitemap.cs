...
using AI.Erp.Plugins.SDK.Model;
	...
	public class WvSdkPageSitemap : ViewComponent
	{
			...
			PageType? presetType = null, Guid? presetAppId = null, Guid? presetEntityId = null)
		{
			...
			if (mode == WvFieldRenderMode.Form)
			{
				...
				var scriptTemplate = FileService.GetEmbeddedTextResource(fileName, "AI.Erp.Plugins.SDK.Components.WvSdkPageSitemap", "AI.Erp.Plugins.SDK");
