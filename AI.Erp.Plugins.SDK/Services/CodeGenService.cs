...
namespace AI.Erp.Plugins.SDK.Services
{
...
"{\n" +
    ...
    "#endregion\n\n";
        ...
        private string CreateCurrencyFieldCode(DbCurrencyField field, Guid entityId, string entityName)
        {
            ...
            response +=
            $"\tcurrencyField.Currency = AI.Erp.Utilities.Helpers.GetCurrencyType(\"{field.Currency.Code}\");\n" +
...
"{\n" +
    ...
    $"\tgeometryField.Label = \"{field.Label}\";\n";
            ...
            {
                response +=
                    $"\tgeometryField.Format = AI.Erp.Api.Models.GeographyFieldFormat.{field.Format.Value};\n";
            }
            else
            {
                response +=
                    $"\tgeometryField.Format = AI.Erp.Api.Models.GeographyFieldFormat.GeoJSON;\n";
            }
            response +=
...
"{\n" +
    ...
    $"\ttreeSelectField.Label = \"{field.Label}\";\n";
        ...
        private string UpdateCurrencyFieldCode(DbCurrencyField currentField, DbCurrencyField oldField, Guid entityId, string entityName)
        {
            ...
            response +=
            $"\tcurrencyField.Currency = AI.Erp.Utilities.Helpers.GetCurrencyType(\"{currentField.Currency.Code}\");\n" +
        ...
        private string UpdateGeographyFieldCode(DbGeographyField currentField, DbGeographyField oldField, Guid entityId, string entityName)
        {
            ...
            {
                response +=
                    $"\tgeometryField.Format = AI.Erp.Api.Models.GeographyFieldFormat.{currentField.Format.Value};\n";
            }
            else
            {
                response +=
...
"{\n" +
    ...
    $"\tpatchObject[\"id\"] = new Guid(\"{(Guid)currentRole["id"]}\");\n";
        ...
        private string CreateAppCode(App app)
        {
            ...
            response += "\n\tnew AI.Erp.Web.Services.AppService().CreateApplication(id,name,label,description,iconClass,author,color,weight,access,AI.Erp.Database.DbContext.Current.Transaction);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private string DeleteAppCode(App app)
        {
            return $"#region << ***Delete app*** App name: {app.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.AppService().DeleteApplication( new Guid(\"{app.Id}\"),AI.Erp.Database.DbContext.Current.Transaction, cascade: false );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreateSitemapAreaCode(SitemapArea area)
        {
            ...
            response += $"\tvar labelTranslations = new List<AI.Erp.Web.Models.TranslationResource>();\n";
            foreach (var res in area.LabelTranslations ?? new List<TranslationResource>())
                response += $"\tlabelTranslations.Add( new AI.Erp.Web.Models.TranslationResource{{ Locale=\"{res.Locale}\", Key= \"{res.Key}\", Value= @\"{res.Value.EscapeMultiline()}\"  }} );\n";

            response += $"\tvar descriptionTranslations = new List<AI.Erp.Web.Models.TranslationResource>();\n";
            foreach (var res in area.DescriptionTranslations ?? new List<TranslationResource>())
                response += $"\tdescriptionTranslations.Add( new AI.Erp.Web.Models.TranslationResource{{ Locale=\"{res.Locale}\", Key= \"{res.Key}\", Value= @\"{res.Value.EscapeMultiline()}\"  }} );\n";


            response += "\n\tnew AI.Erp.Web.Services.AppService().CreateArea(id,appId,name,label,labelTranslations,description,descriptionTranslations,iconClass,color,weight,showGroupNames,access,AI.Erp.Database.DbContext.Current.Transaction);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdateSitemapAreaCode(SitemapArea currentArea, SitemapArea oldArea)
        {
            ...
            "{\n" +
                ...
                response.Code += $"\tvar labelTranslations = new List<AI.Erp.Web.Models.TranslationResource>();\n";
                foreach (var res in currentArea.LabelTranslations ?? new List<TranslationResource>())
                    response.Code += $"\tlabelTranslations.Add( new AI.Erp.Web.Models.TranslationResource{{ Locale=\"{res.Locale}\", Key= \"{res.Key}\", Value= @\"{res.Value.EscapeMultiline()}\"  }} );\n";

                response.Code += $"\tvar descriptionTranslations = new List<AI.Erp.Web.Models.TranslationResource>();\n";
                foreach (var res in currentArea.DescriptionTranslations ?? new List<TranslationResource>())
                    response.Code += $"\tdescriptionTranslations.Add( new AI.Erp.Web.Models.TranslationResource{{ Locale=\"{res.Locale}\", Key= \"{res.Key}\", Value= @\"{res.Value.EscapeMultiline()}\"  }} );\n";

                response.Code += "\n\tnew AI.Erp.Web.Services.AppService().UpdateArea(id,appId,name,label,labelTranslations,description,descriptionTranslations,iconClass,color,weight,showGroupNames,access,AI.Erp.Database.DbContext.Current.Transaction);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeleteSitemapAreaCode(SitemapArea area)
        {
            return $"#region << ***Delete sitemap area*** Area name: {area.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.AppService().DeleteArea( new Guid(\"{area.Id}\"),AI.Erp.Database.DbContext.Current.Transaction, cascade: false );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreateSitemapNodeCode(Guid areaId, SitemapNode node)
        {
            ...
            response += "\n\tnew AI.Erp.Web.Services.AppService().CreateAreaNode(id,areaId,name,label,labelTranslations,iconClass,url,type,entityId,weight,access,entityListPages,entityCreatePages,entityDetailsPages,entityManagePages,AI.Erp.Database.DbContext.Current.Transaction,parentId);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdateSitemapNodeCode(Guid areaId, SitemapNode currentNode, SitemapNode oldNode)
        {
            ...
            "{\n" +
                ...
                response.Code += "\n\tnew AI.Erp.Web.Services.AppService().UpdateAreaNode(id,areaId,name,label,labelTranslations,iconClass,url,type,entityId,weight,access,entityListPages,entityCreatePages,entityDetailsPages,entityManagePages,AI.Erp.Database.DbContext.Current.Transaction,parentId);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeleteSitemapNodeCode(SitemapNode node)
        {
            return $"#region << ***Delete sitemap node*** Node name: {node.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.AppService().DeleteAreaNode( new Guid(\"{node.Id}\"),AI.Erp.Database.DbContext.Current.Transaction );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreateSitemapGroupCode(Guid areaId, SitemapGroup group)
        {
            ...
            response += "\n\tnew AI.Erp.Web.Services.AppService().CreateAreaGroup(id,areaId,name,label,labelTranslations,weight,renderRoles,AI.Erp.Database.DbContext.Current.Transaction);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdateSitemapGroupCode(SitemapGroup currentGroup, SitemapGroup oldGroup)
        {
            ...
            if (response.HasUpdate)
            {
                ...
                response.Code += "\n\tnew AI.Erp.Web.Services.AppService().UpdateAreaGroup(id,areaId,name,label,labelTranslations,weight,renderRoles,AI.Erp.Database.DbContext.Current.Transaction);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeleteSitemapGroupCode(SitemapGroup group)
        {
            return $"#region << ***Delete sitemap group*** Sitemap group name: {group.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.PageService().DeleteAreaGroup( new Guid(\"{group.Id}\"),AI.Erp.Database.DbContext.Current.Transaction);\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreateErpPageCode(ErpPage page)
        {
            ...
            "{\n" +
                ...
                $"\tvar labelTranslations = new List<AI.Erp.Web.Models.TranslationResource>();\n";

            foreach (var res in page.LabelTranslations ?? new List<TranslationResource>())
                response += $"\tlabelTranslations.Add( new AI.Erp.Web.Models.TranslationResource{{ Locale=\"{res.Locale}\", Key= \"{res.Key}\", Value= @\"{res.Value.EscapeMultiline()}\"  }} );\n";

            response += "\n\tnew AI.Erp.Web.Services.PageService().CreatePage(id,name,label,labelTranslations,iconClass,system,weight,type,appId,entityId,nodeId,areaId,isRazorBody,razorBody,layout,AI.Erp.Database.DbContext.Current.Transaction);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private string DeleteErpPageCode(ErpPage page)
        {
            return $"#region << ***Delete page*** Page name: {page.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.PageService().DeletePage( new Guid(\"{page.Id}\"),AI.Erp.Database.DbContext.Current.Transaction, cascade: false );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private UpdateCheckResponse UpdateErpPageCode(ErpPage currentPage, ErpPage oldPage)
        {
            ...
            if (response.HasUpdate)
            {
                ...
                response.Code += "\n\tnew AI.Erp.Web.Services.PageService().UpdatePage(id,name,label,labelTranslations,iconClass,system,weight,type,appId,entityId,nodeId,areaId,isRazorBody,razorBody,layout,AI.Erp.Database.DbContext.Current.Transaction);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string CreatePageBodyNodeCode(PageBodyNode node, string pageName)
        {
            ...
            "{\n" +
                ...
                $"\tvar weight = {node.Weight};\n" +
                "\n\tnew AI.Erp.Web.Services.PageService().CreatePageBodyNode(id,parentId,pageId,nodeId,weight,componentName,containerId,options,AI.Erp.Database.DbContext.Current.Transaction);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdatePageBodyNodeCode(PageBodyNode currentNode, PageBodyNode oldNode, string pageName)
        {
            ...
            if (response.HasUpdate)
            {
                ...
                "{\n" +
                    ...
                    $"\tvar weight = {currentNode.Weight};\n" +
                    "\n\tnew AI.Erp.Web.Services.PageService().UpdatePageBodyNode(id,parentId,pageId,nodeId,weight,componentName,containerId,options,AI.Erp.Database.DbContext.Current.Transaction);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeletePageBodyNodeCode(PageBodyNode node, string pageName)
        {
            return $"#region << ***Delete page body node*** Page name: {pageName} ID: {node.Id} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.PageService().DeletePageBodyNode( new Guid(\"{node.Id}\"),AI.Erp.Database.DbContext.Current.Transaction, cascade: false );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreateDatabaseDataSourceCode(DatabaseDataSource ds)
        {
            ...
            "{\n" +
                ...
                "\n\tnew AI.Erp.Database.DbDataSourceRepository().Create(id,name,description,weight,eqlText,sqlText,parametersJson,fieldsJson,entityName, returnTotal);\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdateDatabaseDataSourceCode(DatabaseDataSource currentDS, DatabaseDataSource oldDS)
        {
            ...
            if (response.HasUpdate)
            {
                ...
                "{\n" +
                    ...
                    "\n\tnew AI.Erp.Database.DbDataSourceRepository().Update(id,name,description,weight,eqlText,sqlText,parametersJson,fieldsJson,entityName,returnTotal);\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeleteDatabaseDataSourceCode(DatabaseDataSource ds)
        {
            return $"#region << ***Delete data source *** Name: {ds.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Api.DataSourceManager().Delete( new Guid(\"{ds.Id}\") );\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        ...
        private string CreatePageDataSourceCode(PageDataSource ds)
        {
            ...
            "{\n" +
                ...
                "\n\tnew AI.Erp.Web.Services.PageService(ErpSettings.ConnectionString).CreatePageDataSource(id, pageId, dataSourceId,name,parameters,AI.Erp.Database.DbContext.Current.Transaction );\n" +
            "}\n" +
            "#endregion\n\n";
        ...
        private UpdateCheckResponse UpdatePageDataSourceCode(PageDataSource currentDS, PageDataSource oldDS)
        {
            ...
            if (response.HasUpdate)
            {
                ...
                "{\n" +
                    ...
                    "\n\tnew AI.Erp.Web.Services.PageService(ErpSettings.ConnectionString).UpdatePageDataSource(id, pageId, dataSourceId,name,parameters,AI.Erp.Database.DbContext.Current.Transaction );\n" +
                "}\n" +
                "#endregion\n\n";
            }
        ...
        private string DeletePageDataSourceCode(PageDataSource ds)
        {
            return $"#region << ***Delete page data source *** Name: {ds.Name} >>\n" +
                    "{\n" +
                        $"\n\tnew AI.Erp.Web.Services.PageService(ErpSettings.ConnectionString).DeletePageDataSource(new Guid(\"{ds.Id}\"),AI.Erp.Database.DbContext.Current.Transaction);\n" +
                    "}\n" +
                    "#endregion\n\n";
        }
        #endregion
