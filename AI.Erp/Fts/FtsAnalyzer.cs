...
namespace AI.Erp.Fts
{
	public class FtsAnalyzer
	{
		...
		public string ProcessText(string text)
		{
			...
			var stemmer = new BulStem.Stemmer(BulStem.StemmingLevel.Low);

			string resultText = "";
			foreach (var word in words)
			{
				if (!BgStopWords.Contains(word))
				{
					string resultWord = word;
					resultWord = stemmer.Stem(resultWord);
