...
2. The AI ERP project is a set of .NET Core application and libraries. 
...
4. AI ERP use PotgreSQL database. You can go download the latest version from https://www.postgresql.org/download/ . 
...
3. Open the solution file AI.Erp.sln with Visual Studio and build the solution. 
Set as startup  (if is not already set). Edit the Config.json file 
in project AI.Erp.Site and set the correct sql connection string. 
...
5. If you want to develop your own components or applications, be sure that the AI.Erp.Plugins.SDK is included in your solution.
