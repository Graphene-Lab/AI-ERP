...
namespace AI.Erp.Plugins.Project.Controllers
{
	[Authorize]
	public class ProjectController : Controller
	{
		...
		public ContentResult TimeTrackJs([FromQuery]string file = "")
		{
			...
			try
			{
				var jsContent = FileService.GetEmbeddedTextResource(file, "AI.Erp.Plugins.Project.Files", "AI.Erp.Plugins.Project");
