...
{
	[PageComponent(Label = "Project Widget Tasks Chart", Library = "AI", Description = "Chart presenting the current project tasks", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
