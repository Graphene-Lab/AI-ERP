...
{
	[PageComponent(Label = "Report: Monthly timelog for an account", Library = "AI", Description = "Reports for the timelog for a selected month and account", Version = "0.0.1", IconClass = "fas fa-calculator")]
