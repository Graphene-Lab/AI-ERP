...
{
	[PageComponent(Label = "Project Widget Budget Chart", Library = "AI", Description = "Chart presenting the current project budget", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
