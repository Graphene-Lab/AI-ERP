...
{
	[PageComponent(Label = "Project Widget Task Distribution", Library = "AI", Description = "Chart presenting the current project opened tasks by user", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
