...
(function (window, $) {
	...
	//		if (event && event.payload && event.payload.component_name === "AI.Erp.Web.Components.PcPostList"){
	...
	//	if (event && event.payload && event.payload.component_name === "AI.Erp.Plugins.Project.Components.PcPostList") {
	//		console.log("AI.Erp.Plugins.Project.Components.PcPostList Moved");
	//	}
	//});
	});
