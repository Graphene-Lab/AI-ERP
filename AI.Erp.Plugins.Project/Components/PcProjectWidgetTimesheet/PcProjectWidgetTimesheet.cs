...
{
	[PageComponent(Label = "Project Widget Timesheet", Library = "AI", Description = "Timesheet for the past 7 days in a project", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
