...
{
	[PageComponent(Label = "Project Widget Priority Chart", Library = "AI", Description = "Chart presenting the current project tasks by priority", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
