...
using AI.Erp.Plugins.Project.Utils;
using AI.Erp.Recurrence;
using AI.Erp.Web;
...
{
	[PageComponent(Label = "Task Repeat Recurrence Set", Library = "AI", Description = "special component for setting task occurrence", Version = "0.0.1", IconClass = "fas fa-retweet")]
