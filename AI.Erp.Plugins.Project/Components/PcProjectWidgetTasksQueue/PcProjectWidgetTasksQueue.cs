...
using AI.Erp.Plugins.Project.Model;
...
{
	[PageComponent(Label = "Project Widget Tasks Queue", Library = "AI", Description = "tasks queue for a project or an user", Version = "0.0.1", IconClass = "fas fa-chart-pie")]
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				if (context.Mode != ComponentMode.Options && context.Mode != ComponentMode.Help)
				{
					...
					{
						var imagePath = "/_content/AI.Erp.Web/assets/avatar.png";
