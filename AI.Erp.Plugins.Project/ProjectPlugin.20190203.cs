...
namespace AI.Erp.Plugins.Project
{
	public partial class ProjectPlugin : ErpPlugin
	{
		private static void Patch20190203(EntityManager entMan, EntityRelationManager relMan, RecordManager recMan)
		{
			...
			#region << ***Create sitemap area*** Sitemap area name: dashboard >>
			{
				...
				var descriptionTranslations = new List<AI.Erp.Web.Models.TranslationResource>();
			...
			#region << ***Create sitemap node*** Sitemap node name: dashboard >>
			{
				...
				new AI.Erp.Web.Services.AppService().CreateAreaNode(id, areaId, name, label, labelTranslations, iconClass, url, type, entityId, weight, access, new List<Guid>(), new List<Guid>(), new List<Guid>(), new List<Guid>(), AI.Erp.Database.DbContext.Current.Transaction);
			}
			#endregion
			...
			#region << ***Create page body node*** Page name: track-time  id: 6bb17b95-258a-4572-99f3-898d1895cfba >>
			{
				...
				var componentName = "AI.Erp.Web.Components.PcValidation";
				var containerId = "";
				var options = @"{
  ""validation"": ""{\""type\"":\""0\"",\""string\"":\""Validation\"",\""default\"":\""\""}""
			...
			#region << ***Create page body node*** Page name: tasks  id: f4f2b086-1181-4db5-b78f-51d1b41e1611 >>
			{
				...
				var componentName = "AI.Erp.Web.Components.PcDrawer";
				var containerId = "";
				var options = @"{
  ""title"": ""Search Tasks"",
  ""width"": ""550px"",
  ...
  ""title_action_html"": """"
			...
			#region << ***Create page body node*** Page name: tasks  id: 7590ab09-b749-4051-935a-b51d16d7b76a >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("6f673561-fad7-4844-8262-589834f1b2ce");
				var componentName = "AI.Erp.Web.Components.PcForm";
  ...
  ""mode"": ""1""
			...
			#region << ***Create page body node*** Page name: tasks  id: df667b11-30ac-4b6b-a12d-41e5aaf6cae5 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("6f673561-fad7-4844-8262-589834f1b2ce");
				var componentName = "AI.Erp.Web.Components.PcButton";
				var containerId = "body";
				var options = @"{
  ""type"": ""1"",
  ""text"": ""Search Tasks"",
  ...
  ""form"": """"
			...
			#region << ***Create page body node*** Page name: tasks  id: 57789d88-e897-4b7b-9999-239821db4274 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("6f673561-fad7-4844-8262-589834f1b2ce");
				var componentName = "AI.Erp.Web.Components.PcGridFilterField";
				var containerId = "body";
				var options = @"{
  ""label"": ""Task contents"",
  ""name"": ""x_search"",
  ...
  ""prefix"": """"
			...
			#region << ***Create page body node*** Page name: list  id: dedd97f6-1b09-4942-aae1-684cdc49a3eb >>
			{
				...
				var componentName = "AI.Erp.Web.Components.PcGrid";
				var containerId = "";
				var options = @"{
  ""visible_columns"": 2,
  ...
  ""container12_searchable"": ""false""
			...
			#region << ***Create page body node*** Page name: list  id: 8f61ba2d-9c8a-434d-9f78-d12926cd80ef >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("2f11031a-41da-4dfc-8e40-ddc6dca71e2c");
				var componentName = "AI.Erp.Web.Components.PcFieldText";
  ...
  ""form"": """"
			...
			#region << ***Create page body node*** Page name: list  id: 13a1d868-93ee-41d1-bb94-231d99899f74 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("2f11031a-41da-4dfc-8e40-ddc6dca71e2c");
				var componentName = "AI.Erp.Web.Components.PcPageHeader";
				var containerId = "";
				var options = @"{
  ...
  ""is_active"": ""false"",
  ""is_disabled"": ""false"",
  ""onclick"": ""ErpEvent.DISPATCH(\""AI.Erp.Web.Components.PcDrawer\"",\""open\"")"",
  ""href"": """",
  ""new_tab"": ""false"",
  ""form"": """"
}";
  ...
  ""return_url"": """"
			...
			#region << ***Create page body node*** Page name: dashboard  id: a584a5ed-96a2-4a28-95e8-23266bc36926 >>
			{
				...
				var componentName = "AI.Erp.Web.Components.PcRow";
				var containerId = "";
				var options = @"{
  ""visible_columns"": 2,
  ""class"": """",
  ...
  ""container12_flex_order"": 0
			...
			#region << ***Create page body node*** Page name: dashboard  id: 63daa5c0-ed7f-432e-bfbb-746b94207146 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("33f2cd33-cf38-4247-9097-75f895d1ef7a");
				var componentName = "AI.Erp.Web.Components.PcSection";
				var containerId = "column2";
				var options = @"{
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: d4c6bc3b-51d5-4f2d-a329-f02c59250a41 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("33f2cd33-cf38-4247-9097-75f895d1ef7a");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetTasksQueue";
				var containerId = "body";
				var options = @"{
  ""project_id"": """",
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: 483e09f0-98c4-4e70-ad9a-3a92abebaf74 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("33f2cd33-cf38-4247-9097-75f895d1ef7a");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetTimesheet";
				var containerId = "body";
				var options = @"""{}""";
				var weight = 1;
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: 5b95ff72-dfc0-4a99-ad3a-6c6107f7bd4c >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("33f2cd33-cf38-4247-9097-75f895d1ef7a");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetTasksChart";
				var containerId = "body";
				var options = @"{
  ""project_id"": """",
  ""user_id"": ""{\""type\"":\""0\"",\""string\"":\""CurrentUser.Id\"",\""default\"":\""\""}""
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: 209d32c9-6c2f-4f45-859a-3ae2718ebf88 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("33f2cd33-cf38-4247-9097-75f895d1ef7a");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetTasksPriorityChart";
				var containerId = "body";
				var options = @"{
  ""project_id"": """",
  ""user_id"": ""{\""type\"":\""0\"",\""string\"":\""CurrentUser.Id\"",\""default\"":\""\""}""
  ...
  ""return_url"": """"
			...
			#region << ***Create page body node*** Page name: account-monthly-timelog  id: d3501ea7-86f2-4230-8bc5-30ffab78be5e >>
			{
				...
				var componentName = "AI.Erp.Plugins.Project.Components.PcReportAccountMonthlyTimelogs";
				var containerId = "";
				var options = @"{
  ...
  ""maxlength"": 0
			...
			#region << ***Create page body node*** Page name: tasks  id: e83f6542-f9f8-4fec-aeb8-48731951f182 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("6f673561-fad7-4844-8262-589834f1b2ce");
				var componentName = "AI.Erp.Web.Components.PcFieldDate";
  ...
  ""maxlength"": 0
			...
			#region << ***Create page body node*** Page name: tasks  id: a20664ce-a3fe-436a-84f0-42f4e14564c1 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("6f673561-fad7-4844-8262-589834f1b2ce");
				var componentName = "AI.Erp.Web.Components.PcFieldHtml";
				var containerId = "column2";
				var options = @"{
  ""label_text"": """",
  ""label_mode"": ""0"",
  ...
  ""container12_horizontal_align"": ""1""
			...
			#region << ***Create page body node*** Page name: track-time  id: 3d0eb8a7-1182-4974-a039-433954aa8d7c >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("e9c8f7ef-4714-40e9-90cd-3814d89603b1");
				var componentName = "AI.Erp.Web.Components.PcFieldHidden";
				var containerId = "column3";
				var options = @"{
  ...
  ""try_connect_to_entity"": ""false""
			...
			#region << ***Create page body node*** Page name: track-time  id: 46657d5a-0102-43b7-9ca3-9259953d37b6 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("e9c8f7ef-4714-40e9-90cd-3814d89603b1");
				var componentName = "AI.Erp.Web.Components.PcBtnGroup";
				var containerId = "column3";
				var options = @"{
  ""size"": ""3"",
  ""is_vertical"": ""false"",
  ...
  ""container12_flex_order"": 0
			...
			#region << ***Create page body node*** Page name: create  id: ace9e1bf-47bf-495f-8e6b-7683d2a0fa78 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("c2e38698-24cd-4209-b560-02c225f3ff4a");
				var componentName = "AI.Erp.Web.Components.PcFieldNumber";
				var containerId = "column3";
				var options = @"{
  ...
  ""mode"": ""0""
			...
			#region << ***Create page body node*** Page name: create  id: 8dc4fd15-a1eb-4b7e-a1a9-381ac8e7de9b >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("c2e38698-24cd-4209-b560-02c225f3ff4a");
				var componentName = "AI.Erp.Web.Components.PcFieldSelect";
				var containerId = "column3";
				var options = @"{
  ...
  ""container12_flex_order"": 0
			...
			#region << ***Create page body node*** Page name: create  id: bf38fcf4-adeb-4388-ad4b-6aa4485f9258 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("c2e38698-24cd-4209-b560-02c225f3ff4a");
				var componentName = "AI.Erp.Web.Components.PcFieldCheckbox";
				var containerId = "column1";
				var options = @"{
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: details  id: 164261ae-2df4-409a-8fdd-adc85c86a6dc >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Web.Components.PcTabNav";
				var containerId = "body";
				var options = @"{
  ""visible_tabs"": 3,
  ""render_type"": ""1"",
  ...
  ""tab7_label"": ""Tab 7""
			...
			#region << ***Create page body node*** Page name: details  id: 05459068-33a7-454e-a871-94f9ddc6e5d5 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Plugins.Project.Components.PcFeedList";
  ...
  ""records"": ""{\""type\"":\""0\"",\""string\"":\""FeedItemsForRecordId\"",\""default\"":\""\""}""
			...
			#region << ***Create page body node*** Page name: details  id: 8099e123-1218-4008-b8e6-8ff56678d64a >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Plugins.Project.Components.PcTimelogList";
  ...
  ""records"": ""{\""type\"":\""0\"",\""string\"":\""TimeLogsForRecordId\"",\""default\"":\""\""}""
			...
			#region << ***Create page body node*** Page name: details  id: 3e15a63d-8f5f-4357-a692-b5998c31d543 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Plugins.Project.Components.PcPostList";
  ...
  ""connected_entity_id"": """"
			...
			#region << ***Create page body node*** Page name: details  id: f2175b92-4941-4cbe-ba4b-305167b6738b >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Web.Components.PcHtmlBlock";
				var containerId = "body";
				var options = @"{
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: details  id: 798e39b3-7a36-406b-bed6-e77da68fc50f >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Web.Components.PcFieldDateTime";
				var containerId = "body";
				var options = @"{
  ""label_text"": """",
  ""label_mode"": ""0"",
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: 4c58c1bb-321a-41c6-954f-4c6fafe6661c >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("50e4e84d-4148-4635-8372-4f2262747668");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetBudgetChart";
				var containerId = "body";
				var options = @"{
  ""project_id"": ""{\""type\"":\""0\"",\""string\"":\""Record.id\"",\""default\"":\""\""}""
}";
  ...
  ""is_collapsed"": ""false""
			...
			#region << ***Create page body node*** Page name: dashboard  id: becc4486-be49-4fa6-9d3a-0d8e15606fcc >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("50e4e84d-4148-4635-8372-4f2262747668");
				var componentName = "AI.Erp.Plugins.Project.Components.PcProjectWidgetTaskDistribution";
				var containerId = "body";
				var options = @"{
  ""project_id"": ""{\""type\"":\""0\"",\""string\"":\""Record.id\"",\""default\"":\""\""}""
}";
  ...
  ""return_url"": """"
			...
			#region << ***Create page body node*** Page name: track-time  id: 6694f852-c49e-4dd2-a4dc-dd2f6faaf4b4 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("e9c8f7ef-4714-40e9-90cd-3814d89603b1");
				var componentName = "AI.Erp.Web.Components.PcModal";
				var containerId = "";
				var options = @"{
  ...
  ""try_connect_to_entity"": ""false""
			...
			#region << ***Create page body node*** Page name: track-time  id: 418b58a8-88d2-4dfc-b4a9-22617dab76c4 >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("e9c8f7ef-4714-40e9-90cd-3814d89603b1");
				var componentName = "AI.Erp.Web.Components.PcFieldTextarea";
				var containerId = "body";
				var options = @"{
  ""label_text"": ""Description"",
  ""label_mode"": ""0"",
  ...
  ""is_active"": ""false"",
  ""is_disabled"": ""false"",
  ""onclick"": ""ErpEvent.DISPATCH('AI.Erp.Web.Components.PcModal',{htmlId:'wv-6694f852-c49e-4dd2-a4dc-dd2f6faaf4b4',action:'close',payload:null})"",
  ""href"": """",
  ""new_tab"": ""false"",
  ""form"": """"
}";
...
";
				...
				new AI.Erp.Database.DbDataSourceRepository().Create(id, name, description, weight, eqlText, sqlText, parametersJson, fieldsJson, entityName);
			}
			#endregion
