	...
	public partial class ProjectPlugin : ErpPlugin
	{
		private static void Patch20190207(EntityManager entMan, EntityRelationManager relMan, RecordManager recMan)
		{
			...
			#region << ***Delete page body node*** Page name: create ID: ecef4b2c-6988-44c1-acea-0e28385ec528 >>
			{
				...
				new AI.Erp.Web.Services.PageService().DeletePageBodyNode(new Guid("ecef4b2c-6988-44c1-acea-0e28385ec528"), AI.Erp.Database.DbContext.Current.Transaction, cascade: false);
			}
			#endregion
			...
			#region << ***Delete page body node*** Page name: create ID: 884a8db1-aff0-4f86-ab7d-8fb17698fc33 >>
			{
				...
				new AI.Erp.Web.Services.PageService().DeletePageBodyNode(new Guid("884a8db1-aff0-4f86-ab7d-8fb17698fc33"), AI.Erp.Database.DbContext.Current.Transaction, cascade: false);
			}
			#endregion
