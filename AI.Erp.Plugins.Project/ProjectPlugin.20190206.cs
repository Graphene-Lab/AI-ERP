	...
	public partial class ProjectPlugin : ErpPlugin
	{
		private static void Patch20190206(EntityManager entMan, EntityRelationManager relMan, RecordManager recMan)
		{
			#region << ***Delete page body node*** Page name: details ID: 291477ec-dd9c-4fc3-97a0-d2fd62809b2f >>
			{
				...
				new AI.Erp.Web.Services.PageService().DeletePageBodyNode(new Guid("291477ec-dd9c-4fc3-97a0-d2fd62809b2f"), AI.Erp.Database.DbContext.Current.Transaction, cascade: false);
			}
			#endregion
			...
			#region << ***Delete page body node*** Page name: details ID: 798e39b3-7a36-406b-bed6-e77da68fc50f >>
			{
				...
				new AI.Erp.Web.Services.PageService().DeletePageBodyNode(new Guid("798e39b3-7a36-406b-bed6-e77da68fc50f"), AI.Erp.Database.DbContext.Current.Transaction, cascade: false);
			}
			#endregion
