	...
	public partial class ProjectPlugin : ErpPlugin
	{
		private static void Patch20190222(EntityManager entMan, EntityRelationManager relMan, RecordManager recMan)
		{
			...
			#region << ***Delete page data source *** Name: ProjectWidgetMyTasks >>
			{
				...
				new AI.Erp.Web.Services.PageService(ErpSettings.ConnectionString).DeletePageDataSource(new Guid("e688cbdd-0fa9-43b4-aed1-3d667fdecf87"), AI.Erp.Database.DbContext.Current.Transaction);
			}
			#endregion
			...
			#region << ***Delete page data source *** Name: ProjectWidgetMyTasksDueToday >>
			{
				...
				new AI.Erp.Web.Services.PageService(ErpSettings.ConnectionString).DeletePageDataSource(new Guid("f1da592e-d696-426a-a60c-ef262d101a56"), AI.Erp.Database.DbContext.Current.Transaction);
			}
			#endregion
			...
			#region << ***Delete data source *** Name: ProjectAuxData >>
			{
				...
				new AI.Erp.Api.DataSourceManager().Delete(new Guid("3c5a9d64-47ea-466a-8b0e-49e61df58bd1"));
			}
			#endregion
			...
			#region << ***Delete data source *** Name: ProjectWidgetMyTasksDueToday >>
			{
				...
				new AI.Erp.Api.DataSourceManager().Delete(new Guid("eae07b63-9bf4-4e25-80af-df5228dedf35"));
			}
			#endregion
			...
			#region << ***Delete data source *** Name: TaskComments >>
			{
				...
				new AI.Erp.Api.DataSourceManager().Delete(new Guid("f68fa8be-b957-4692-b459-4da62d23f472"));
			}
			#endregion
			...
			#region << ***Delete data source *** Name: ProjectWidgetMyTasks >>
			{
				...
				new AI.Erp.Api.DataSourceManager().Delete(new Guid("c44eab77-c81e-4f55-95c8-4949b275fc99"));
			}
			#endregion
			...
			#region << ***Delete data source *** Name: ProjectWidgetMyOverdueTasks >>
			{
				...
				new AI.Erp.Api.DataSourceManager().Delete(new Guid("946919a6-e4cd-41a2-97dc-1069d73adcd1"));
			}
			#endregion
			...
			#region << ***Delete page body node*** Page name: details ID: d076f406-7ddd-4feb-b96a-137e10c2d14e >>
			{
				...
				new AI.Erp.Web.Services.PageService().DeletePageBodyNode(new Guid("d076f406-7ddd-4feb-b96a-137e10c2d14e"), AI.Erp.Database.DbContext.Current.Transaction, cascade: false);
			}
			#endregion
...
";
				...
				new AI.Erp.Database.DbDataSourceRepository().Update(id, name, description, weight, eqlText, sqlText, parametersJson, fieldsJson, entityName);
			}
			#endregion
