...
namespace AI.Erp.Plugins.Project
{
  ...
  ""is_active"": ""false"",
  ""is_disabled"": ""false"",
  ""onclick"": ""ErpEvent.DISPATCH('AI.Erp.Web.Components.PcModal',{htmlId:'wv-97402edb-3a5a-4cc3-bc40-4d4d012619e2',action:'close',payload:null})"",
  ""href"": """",
  ""new_tab"": ""false"",
  ""form"": """"
}";
  ...
  ""mode"": ""1""
			...
			#region << ***Create page body node*** Page name: details  id: c2081b0a-c230-4f5a-959e-75c78c70132f >>
			{
				...
				Guid? nodeId = null;
				var pageId = new Guid("3a40b8e6-0a87-4eee-9b6b-6c665ebee28c");
				var componentName = "AI.Erp.Plugins.Project.Components.PcTaskRepeatRecurrenceSet";
				var containerId = "body";
				var options = @"{}";
				var weight = 2;
